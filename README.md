...
![Figure 1: Hardware architecture and data flow in snake_top.](./docs/snake_arch.svg)
...
![Figure 2: Implementation on FPGA](./docs/1.jpeg)

*Figure 2: Implementation on FPGA*

![Figure 3: Working operation evidence](./docs/2.jpg)
